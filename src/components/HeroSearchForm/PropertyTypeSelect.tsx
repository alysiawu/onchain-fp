...
const typeOfProperty = [
  {
    ...
    description: "frontend, fullstack, blockchain etc",
    checked: true,
  },
  {
    name: "Design",
    description: "UX, user search research",
    checked: true,
  },
  {
    name: "Marketing",
    description: "Drive the strategy and execution of all marketing efforts.",
  },
  {
    name: "Commmunity Manager",
    description: "Build, grow and manage the community",
    checked: true,
  },
];
        ...
        <>
          ...
          >
            ...
            <div className="flex-grow">
              <span className="block xl:text-lg font-semibold">Professions</span>
