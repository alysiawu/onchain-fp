...
const PostJob: FC<PageUploadItemProps> = ({ className = "" }) => {
  ...
  const submitAJob = async () => {
    ...
    const writeUserData = (title: string, jobDescription: string, video: string, location: string, primaryRole: string,  typeofPosition: string) => {
...
{/* 
            ...
            */}
            ...
            <FormItem label="2 min Personalized Video of you pitching this position for potential candiates. (loom link)*">
              <Input 
...
<h3 className="text-lg sm:text-2xl font-semibold">
              ...
              {/* <h3 className="text-lg sm:text-2xl font-semibold"> */}
              {/* <a style={{background: '#39ff14', padding: '12px', 'boxShadow': '0 0 50px #39ff14', borderRadius: '20px', color: '#111'}}> 
                ...
                <span style={{paddingTop: '10px'}}>
                    ...
                    style={{background: 'none', margin: '1rem', marginTop: '10px'}}
                      ...
                      url={'https://www.futureprotocol.co/post-job'}
