...
import ReputationToken from "components/HeroSearchForm/ReputationToken";
...
const Achievement: FC<SectionGridAuthorBoxProps> = ({
  className = "",
  boxCard = "box1",
  sectionStyle = "style1",
  ...
  const renderCard = (index: number) => {
    return <ReputationToken index={index} />
    // switch (boxCard) {
    //   case "box1":
    //     return (
    //       <CardAuthorBox
