        ...
        <div className="flex-shrink-0 flex items-center justify-end text-neutral-700 dark:text-neutral-100 space-x-1">
          ...
          {/* <Logo /> */}
            ...
            <a
              ...
              style={{padding: '10px 15px', 'boxShadow': '0 0 50px #39f889',  background: '#39f889', borderRadius: '20px', color: '#000'}}
            onClick={onOpen}>Connect Wallet {active}</a>
          ) : (
          ...
          onClick={disconnect}>Disconnect</a>
            ...
            <a style={{ padding: '10px 15px', 'boxShadow': '0 0 50px #39f889', borderRadius: '20px', color: '#39f889'}} href={'https://airtable.com/shr8LtmwYtzXAELuQ'} >Join Beta</a>
            <div></div>
