...
const DiscoverWallets: FC<SectionGridAuthorBoxProps> = ({
  className = "",
  boxCard = "box1",
  sectionStyle = "style1",
...
//   } ))
  ...
  {
    name: 'Transhumanist',
    wallet: '0xa7888f85bd76deef3bd03d4dbcf57765a49883b3'
},
{
  name: 'vitalik',
  wallet: '0xc1e42f862d202b4a0ed552c1145735ee088f6ccf'
        ...
        {
            name: 'FOMO',
            wallet: '0x3ec6732676db7996c1b34e64b0503f941025cb63'
        },
        {
            name: 'EverydayWhale',
            wallet: '0x26fcbd3afebbe28d0a8684f790c48368d21665b5'
        },
        {
            name: 'Miyazaki',
            wallet: '0xdb9d281c3d29baa9587f5dac99dd982156913913'
        },
        // {
        //     name: 'blurr',
        ...
        {
            name: 'sifu',
            wallet: '0x5dd596c901987a2b28c38a9c1dfbf86fffc15d77'
        },
        {
            name: 'BoredApe',
            wallet: '0x188c30e9a6527f5f0c3f7fe59b72ac7253c62f28'
        },
        {
            name: 'TradFiWhale',
            wallet: '0x1d5e65a087ebc3d03a294412e46ce5d6882969f4'
        },
        {
            name: 'Gekko',
            wallet: '0xb72ed8401892466ea8af528c1af1d0524bc5e105'
        },
        {
            name: 'SoldmanGachs',
            wallet: '0xa4c8d9e4ec5f2831701a81389465498b83f9457d'
        },

        {
          name: 'beaker',
          wallet: '0x69bab6810fa99475854bca0a3dd72ae6a0728ece'
      },
      {
        name: 'blurr',
        wallet: '0xef764bac8a438e7e498c2e5fccf0f174c3e3f8db'
    ...
    {
      name: 'Phury',
      wallet: '0xe70981f2aeb601a12001465c7a5e52aa76adcbec'
  },
...
{
  name: 'Analytico',
  wallet: '0xa0f75491720835b36edc92d06ddc468d201e9b73'
},

{
  name: 'TradFiWhale',
  wallet: '0x5c9e30def85334e587cf36eb07bdd6a72bf1452d'
},
{
  name: 'Crypto',
  wallet: '0xeb63ee9c8be4c1d14c6d352fad5ca8f933be7af8'
},
{
  name: 'oxycarbon',
  wallet: '0xf69ea6646cf682262e84cd7c67133eac59cef07b'
},

{
  name: 'elonmusk',
  wallet: '0x79c4213a328e3b4f1d87b4953c14759399db25e2'
},
...
{
  name: 'Bitcoin',
  wallet: '0x09d4083ffd20d21acb9118465ad7c52ac8b548f7'
},

{
  name: 'a16z',
  wallet: '0x66b870ddf78c975af5cd8edc6de25eca81791de1'
},
        ...
        return (
            <WalletPill
              ...
              <div className="flex items-center justify-center sm:space-x-2.5 text-xs sm:text-sm ">
                  ...
                  <img src={`https://api.multiavatar.com/${item.name}.svg`} style={{
                  width: '25px'
                  }} />
                  <span>{item.name} | {item.wallet.slice(0, 6)}
...
{/* <a style={{background: '#19FDA6', padding: '12px', 'boxShadow': '0 0 50px #19FDA6', borderRadius: '20px', color: '#111'}} 
            onClick={() => {
                setShowMorWalletPille(!showMore)
            }}
          >Show more</a> */}
...
export default DiscoverWallets;
