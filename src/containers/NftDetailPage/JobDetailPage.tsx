...
const JobDetailPage: FC<NftDetailPageProps> = ({
  className = "",
  isPreviewMode,
}) => {
    ...
    return (
      <div className="divide-y divide-neutral-100 dark:divide-neutral-800">
        ...
        {/* PRICE */}
            ...
            <a style={{background: '#19FDA6', padding: '12px', 'boxShadow': '0 0 50px #19FDA6', borderRadius: '20px', color: '#111'}} href={referralForm} >Refer Or Apply Now</a>
        ...
        <div className="pb-9 pt-14">
          ...
          <div className="mt-8 flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
            {/* <ButtonPrimary onClick={
              ...
              <span className="ml-2.5">Refer Or Apply Now</span>
            </ButtonPrimary> */}
      ...
      <main className="container mt-11 flex ">
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-14">
          ...
          <div className="space-y-8 lg:space-y-10">
            ...
            {requirement.split(';').map((re: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | React.ReactFragment | React.ReactPortal | null | undefined) => {
                    return (
                        <p className="flex items-center "> - {re}</p>
                    )
                })}
            {/* <JobDetail oppo={oppo}/> */}
          </div>
