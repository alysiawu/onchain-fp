...
const GatedTimePage: FC<AuthorPageProps> = ({ className = "" }) => {
...
//   const hasFounderPass = (account: string) => {
//     const ownerAddress = checkOwnerOfNFT(
//         {
//             account,
// contractAddress: '0x495f947276749ce646f68ac8c248420045cb7b5e',
// tokenId: '56952297318167340653809036379497987647842960969605107206914527151832204050433'
...
//   }
  ...
  // useEffect(() => {
  //   account && hasFounderPass('0x08981fdCF3459f610Aec0A8DE465a9a5830c2f22')
  // }, [account])
...
const _getNFTs = async (wallet: string) => {
  ...
  _nftData.forEach(nft => {
    if (nft.contract.address == "0x495f947276749ce646f68ac8c248420045cb7b5e") {
  ...
  _nftDataPolygon.forEach(_nft => {
    ...
    if (_nft.contract.address == "0x2aa03c9cd829f57a0ea4bbb496547308f6e10874") {
...
useEffect(() => {
  ...
  // 0x08981fdCF3459f610Aec0A8DE465a9a5830c2f22
    account && _getNFTs(account)
...
{ avatarString && reservedDomains.indexOf(avatarString) === -1 && <a className="mt-10" style={{background: '#19FDA6', padding: '10px', 'boxShadow': '0 0 50px #19FDA6', borderRadius: '20px', color: '#111'}} href="https://buy.stripe.com/9AQaIwaTneCe9Z68wA" 
      ...
      {!hasAccess && <h2 className="text-3xl sm:text-4xl font-semibold">
               ...
               style={{
                ...
                color: '#19FDA6', padding: '10px', 'boxShadow': '0 0 50px #19FDA6', borderRadius: '40px', fontSize: '2rem', 
                // color: '#111'
            
            }} 

                > marketplace </a>  to buy an access NFT
                  {/* ({nftDataETH.length}) */}
                </h2>}
      ...
      {hasAccess && <h2 className="text-3xl sm:text-4xl font-semibold">
                 ...
                 You have access to {pageSlug}'s availability
                  {/* ({nftDataETH.length}) */}
                </h2>}
        ...
        <span></span><div>
            ...
            <span className="flex items-center py-3 justify-between px-5">September 27 (Tuesday):</span>
            <div><span>&nbsp;</span><span>&nbsp;</span><span>&nbsp;</span><span>•</span><span>&nbsp;</span><a href="https://book.vimcal.com/t/7e615af34d8a1aa4da8b4adc?index=0" rel="noopener noreferrer" target="_blank"  style={{color: 'rgb(25, 116, 232)'}}>2:15 PM - 4:00 PM</a></div><span className="flex items-center py-3 justify-between px-5">September 28 (Wednesday):</span><div><span>&nbsp;</span><span>&nbsp;</span><span>&nbsp;</span><span>•</span><span>&nbsp;</span><a href="https://book.vimcal.com/t/7e615af34d8a1aa4da8b4adc?index=1" rel="noopener noreferrer" target="_blank" 
            style={{color: 'rgb(25, 116, 232)'}}
            >2:30 PM - 4:30 PM</a></div><span className="flex items-center py-3 justify-between px-5">September 29 (Thursday):</span><div><span>&nbsp;</span><span>&nbsp;</span><span>&nbsp;</span><span>•</span><span>&nbsp;</span><a href="https://book.vimcal.com/t/7e615af34d8a1aa4da8b4adc?index=2" rel="noopener noreferrer" target="_blank"  style={{color: 'rgb(25, 116, 232)'}}>1:45 PM - 4:30 PM</a></div><div>
...
<CommunitiesPage />
<h2 className="text-5xl sm:text-4xl font-semibold text-center">Gated Content</h2>
<Why />
