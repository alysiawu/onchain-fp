...
const AvatarString: FC<LocationInputProps> = ({
  defaultValue,
  autoFocus = false,
  onChange,
  onInputDone,
  ...
  const renderRecentSearches = () => {
    return (
      <>
        ...
        <div className="mt-4">
          {[
            "Smart Contract Auditor@OpenZeplin Salary Info NFT",
            "Blockchain Enigneer@Protocol Labs TC NFT",
            "Sr. Compiler Engineer@Polygon Salary Info NFT",
            "Director of Biz Dec@Unstoppable Domain Salary Info NFT",
          ].map((item) => (
            <span
