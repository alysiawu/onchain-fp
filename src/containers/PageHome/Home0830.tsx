...
import SectionHeroBeta from "components/SectionHero/SectionHeroBeta";
import HeroSearchForm from "components/HeroSearchForm/HeroSearchForm";
import PseudonymSearchForm from "components/HeroSearchForm/PseudonymSearchForm";
  ...
  return (
    <div className="nc-PageHome relative overflow-hidden">
      ...
      <div className="container relative space-y-24 my-24 lg:space-y-32 lg:my-32">
        ...
        <div className="">
        <a style={{background: '#19FDA6', padding: '12px', width: '200px', 'boxShadow': '0 0 50px #19FDA6', borderRadius: '20px', color: '#111'}} href={'mailto:hello@futureprotocol.co'}>Message Us</a>
