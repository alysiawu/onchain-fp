...
const VIDEOS_DEMO: VideoType[] = [
  {
    id: "RzVvThhjAKw",
    title: "We bring blockchain to you",
    thumbnail:
      "https://i.postimg.cc/wTPPPj29/Screen-Shot-2022-09-20-at-1-21-15-AM.png",
  },
];

const CurateVideo: FC<SectionVideosProps> = ({
  videos = VIDEOS_DEMO,
  className = "mb-10",
}) => {
    ...
    return (
      ...
      >
        {isPlay ? (
          ...
          <iframe 
            src="https://www.youtube.com/embed/TEVY4xwPRO0" title="YouTube video player" 
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; fullscreen"
            frameBorder="0" 
            allowFullScreen
            className="rounded-3xl"
