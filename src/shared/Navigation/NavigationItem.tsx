...
export interface NavItemType {
  id: string;
  name: string;
  href: keyof LocationStates | "#" | "/#" | '/linkedin';
  targetBlank?: boolean;
...
const NavigationItem: FC<NavigationItemWithRouterProps> = ({
  ...
  const renderDropdownMenuNavlink = (item: NavItemType) => {
    const activeClassName="!font-medium !text-neutral-900 dark:!text-neutral-100"
  ...
  const renderMainItem = (item: NavItemType) => {
    const  activeClassName2="!font-semibold !text-neutral-900 bg-neutral-100 dark:bg-neutral-800 dark:!text-neutral-100"
    return (
      <NavLink
        // exact
        // strict
