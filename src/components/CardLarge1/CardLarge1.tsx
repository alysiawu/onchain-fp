...
const CardLarge1: FC<CardLarge1Props> = ({
  ...
  const randomTitle = [
    "Smart Contract Auditor @Openzeplin",
    // "Smart Contract Engineer @Uniswap",
    // "Fullstack Dapp eng @CreatorDao",
    // "Fullstack @ProtocolLabs",
    // "Senior Eng @MagicEden",
  ];
  return (
    <div
        ...
        <div className="nc-CardLarge1__left p-4 sm:p-8 xl:py-14 md:px-10 bg-white dark:bg-neutral-900 shadow-lg rounded-3xl space-y-3 sm:space-y-8 ">
          ...
          <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-12">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <div className="text-xs dark:text-neutral-400">Title</div>
                <div className="text-sm font-semibold flex items-center">
                  <span>L4 Engineer</span>
                  <VerifyIcon />
                </div>
              </div>
            </div>
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <div className="text-xs dark:text-neutral-400">Company</div>
                <div className="text-sm font-semibold ">Cool Protocol Lab</div>
              </div>
            </div>
          </div>
