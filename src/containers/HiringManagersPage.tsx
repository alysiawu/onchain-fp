          ...
          <div className="flex flex-col mt-12 lg:mt-16 space-y-5 sm:space-y-0 sm:space-x-3 sm:flex-row sm:justify-between sm:items-center">
            ...
            {/* <ButtonPrimary loading>Show me more</ButtonPrimary> */}
             <div className="mv-10">
               ...
               <a style={{background: '#19FDA6', padding: '12px', 'boxShadow': '0 0 50px #19FDA6', borderRadius: '20px', color: '#111'}} href="mailto:hello@futureprotocol.co" >Apply to be the boss to hire</a>
