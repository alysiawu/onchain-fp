...
const QuickApplyTalent: FC<PageUploadItemProps> = ({ className = "" }) => {
  ...
  const submitAsTalent = async () => {
    ...
    trackEvent('QuickApplyPage_Submitting', {
      uid,
      ...formInput
    })
    ...
    trackEvent('QuickApplyPage_Success', {
      uid,
      ...formInput
    })
...
export default QuickApplyTalent;
