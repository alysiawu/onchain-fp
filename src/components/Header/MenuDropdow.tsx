...
// import { placeholderAvatar } from "utils/constants";

export default function MenuDropdown({ copy, type} : { copy: string; type: 'jobSeeker' | 'hiring' | 'connector' | 'advocate' | 'on-chain'}) {
