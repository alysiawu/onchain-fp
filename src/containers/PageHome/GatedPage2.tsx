                ...
                <div style={{position: 'relative', }} className="">
                  ...
                  <Input
                    ...
                    autoFocus
                          // ref={inputRef}
                    type='text'
                    placeholder="Paste a wallet address here e.g. 0x7de9DBa3154fe4e82d9c7BAeE3DD31D0237c8302"
                    onChange={
                      (e) => {
                  ...
                  />
                    ...
                    //    href={userName ?  `/register?username=${userName}`: 'javascript:void(0)'} 
                       onClick={() => {
                        ...
                        trackEvent('QueryTheBlockCTAbtn_Clicked', {
                          library,
                          chainId,
                          account,
                          activate,
  ...
  return (
    <div className="nc-PageHome relative overflow-hidden">
      ...
      <div className="container relative mt-5 mb-5 sm:mb-5 lg:mt-20 lg:mb-32">
        ...
        <Heading
          className="mb-12 lg:mb-14 text-neutral-900 dark:text-neutral-50 mt-10"
          fontClass="text-xl md:text-xl 2xl:text-5xl font-semibold"
          isCenter
          desc=""
        >
        Explore Wallets with NFTs
        </Heading>
        <div className="container relative sm:mb-24 lg:mt-20 lg:mb-32">
        </div>
          <DiscoverWallets
