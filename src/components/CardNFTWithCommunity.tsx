...
const CardNFTWithCommunity: FC<CardNFTProps> = ({ chain, className = "", isLiked, nft, owner, unit }) => {
...
// const contractAddress = nft?.contract?.address
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between">
          {/* {renderAvatars()} */}
          {nft?.rawMetadata?.description?.slice(0, 27)}...
          {/* {nft.title} 
          {nft?.compiler} */}
        ...
        <div className="flex justify-between items-end ">
          {/* <Prices labelTextClassName="bg-white dark:bg-neutral-900 dark:group-hover:bg-neutral-800 group-hover:bg-neutral-50" 
            ...
            unit={unit}
          /> */}
           {/* <a style={{ padding: '10px 15px', 'boxShadow': '0 0 50px #19FDA6', borderRadius: '20px', color: '#19FDA6'}} 
...
export default CardNFTWithCommunity;
