...
const InterviewerOnboarding: FC<PageUploadItemProps> = ({ className = "" }) => {
  ...
  trackEvent('InterviewerApplyPage_Visted', {
    email, 
    uid,
  })
  ...
  const submitAsInterviewer = async () => {
    ...
    trackEvent('InterviewerApplyPage_Submitting', {
      uid,
      ...formInput
    })
    ...
    trackEvent('InterviewerApplyPage_Success', {
      uid,
      ...formInput
    })
...
// const dropdownPositon = 'down'
  return (
    ...
    >
      <Helmet>
        <title>Do you have what it takes to join Talent Nation as an Interviewer?</title>
      </Helmet>
        ...
        <div className="my-12 sm:lg:my-16 lg:my-24 max-w-4xl mx-auto space-y-8 sm:space-y-10">
          ...
          <div className="max-w-2xl">
            <h2 className="text-3xl sm:text-4xl font-semibold">
              ...
              Do you have what it takes to join Talent Nation as an Interviewer?
              ...
              <a style={{background: '#39f889', padding: '12px', 'boxShadow': '0 0 50px #39f889', borderRadius: '20px', color: '#111'}} href={'https://discord.gg/bGq3zG7t77'} >Join our Discord Community</a>
                ...
                ✨ Share on twitter here
                    ...
                    style={{background: 'none', margin: '1rem', marginTop: '10px'}}
                      title={"I help interviewing tech candidates at https://www.futureprotocol.co"}
                      url={'https://www.futureprotocol.co/interviewer-onboarding'}
                      hashtags={["futureprotocol", "talentnation", "decentralizedtechscreening", "decentralizedtechinterview", "newprofessionalidentity"]}
                    >
